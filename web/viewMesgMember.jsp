...
<html>
    <head>
        ...
        <title>Messages From Members</title>
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-giJF6kkoqNQ00vy+HMDP7azOuL0xtbfIcaT9wjKHr8RbDVddVHyTfAAsrekwKmP1" crossorigin="anonymous">
        <link rel="stylesheet" href="messagestaffmemberstudents/myystyle.css">
        ...
        <section class="signup" >
         ...
         if (c != 0) {%>
                ...
                <%
                    ...
                    List<messagestaffmember> messages = messageDaoImpl.showAllMessage((String) session.getAttribute("memId"));
                    if (messages.size() != 0) {
                ...
                <h4 class="nomesg" style="text-align: center; color: red;"> There are no messages</h4> <br> <br><br>
