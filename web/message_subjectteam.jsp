<%-- 
    Document   : message_subjectteam
    Created on : Jan 4, 2021, 1:20:55 PM
    Author     : Dell
--%>
...
<%@page import="javainfinite.DAOImpl.messagestaffmemberDaoImpl"%>
<%@page import="javainfinite.pojo.messagestaffmember"%>
...
<html>
    <head>
        ...
        <title>Send Message To Subject Team</title>
        <script>
            function validate(form) {

                if (form.id.value === "") {
                    alert("Please write subject id!");
                    return false;
                }
         ...
         if (c != 0) {%>
                ...
                <div class="signup-content">
                    ...
                    <div class="signup-form">
                        <h2 class="form-title">Send Message all Team</h2>
                        <form id="myform" onsubmit="return validate(this);" action="messageController" class="register-form" id="login-form">
                            ...
                            <div class="form-group2">
                                ...
                                <input type="text" name="id" id="your_name" placeholder="Subject ID"/>
                            </div> <br>
                            <textarea  rows="4" cols="55" name="message" form="myform"></textarea>

                            <div class="form-group form-button">
                                <input type="submit" name="sendToteam" id="signin" class="form-submit send" value="Send"/>
                            </div>
