<%-- 
    Document   : sentmessage_staff_staff
    Created on : Jan 4, 2021, 12:00:09 PM
    Author     : Dell
--%>
...
<html>
    <head>
        ...
        <title>Send Message To Staffmember</title>
        <script>
         ...
         if (c != 0) {%>
                ...
                <!-- End nav-->          <div class="signup-content">
                    ...
                    <div class="signup-form">
                        <h2 class="form-title">Send Message to Member</h2>
                        <form id="myform" onsubmit="return validate(this);" action="messageController" class="register-form" id="login-form">
                            ...
                            <div class="form-group form-button">
                                <input type="submit" name="sendTomember" id="signin" class="form-submit send" value="Send"/>
                            </div>
